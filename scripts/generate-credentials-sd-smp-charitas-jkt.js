/**
 * Generate Email and Password for SD_SMP_CHARITAS_JKT students
 * Usage: node scripts/generate-credentials-sd-smp-charitas-jkt.js
 *
 * Note: The source CSV has all students marked as "SD", but grades 7-9 are SMP.
...
const INPUT_FILE = path.join(__dirname, '..', 'Daftar Student', 'SD_SMP_CHARITAS_JKT_List_Full.csv');
const OUTPUT_FILE = path.join(__dirname, '..', 'Daftar Student', 'SD_SMP_CHARITAS_JKT_List_With_Credentials.csv');
...
function main() {
  console.log('===========================================');
  console.log('GENERATE CREDENTIALS - SD & SMP CHARITAS JKT');
  console.log('===========================================\n');
