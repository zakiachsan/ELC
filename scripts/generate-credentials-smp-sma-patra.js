/**
 * Generate Email and Password for SMP_SMA_ABDI_SISWA_PATRA students
 * Usage: node scripts/generate-credentials-smp-sma-patra.js
 *
...
const INPUT_FILE = path.join(__dirname, '..', 'Daftar Student', 'SMP_SMA_ABDI_SISWA_PATRA_List_Full.csv');
const OUTPUT_FILE = path.join(__dirname, '..', 'Daftar Student', 'SMP_SMA_ABDI_SISWA_PATRA_List_With_Credentials.csv');
...
function main() {
  console.log('===========================================');
  console.log('GENERATE CREDENTIALS - SMP & SMA ABDI SISWA PATRA');
  console.log('===========================================\n');
