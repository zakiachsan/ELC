...
export const ParentTeacherReview: React.FC = () => {
  const { user } = useAuth();
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2">
                ...
                <textarea
                  ...
                  disabled={isViewOnly}
                  placeholder="Berikan masukan atau saran untuk guru anak Anda..."
                  rows={3}
    ...
    <div className="space-y-4">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
        <div>
          ...
          <p className="text-xs text-gray-500">
            Berikan penilaian untuk guru anak Anda setiap bulan
          </p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          <h3 className="font-bold text-purple-800 text-sm">Review dari Orang Tua</h3>
          <p className="text-xs text-purple-700 mt-0.5">
            Review Anda sangat berharga untuk meningkatkan kualitas pengajaran anak Anda
          </p>
        </div>
      </div>
...
export default ParentTeacherReview;
