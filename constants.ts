...
export const MOCK_SESSIONS: ClassSession[] = [
  // SMA Negeri 1 Jakarta - Sessions
  {
    ...
    skillCategories: [SkillCategory.SPEAKING],
  ...
  },
  {
    ...
    skillCategories: [SkillCategory.GRAMMAR],
  ...
  },
  {
    ...
    skillCategories: [SkillCategory.WRITING],
  ...
  },
  {
    ...
    skillCategories: [SkillCategory.READING],
    difficultyLevel: DifficultyLevel.INTERMEDIATE,
  ...
  },
  {
    ...
    skillCategories: [SkillCategory.LISTENING],
    difficultyLevel: DifficultyLevel.ELEMENTARY,
